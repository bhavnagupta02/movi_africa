...
//$user_id = $_SESSION['user_id'];
 $user_unq= $_SESSION['IdSer'];
    ...
    $stmt = $user_home->runQuery("SELECT *  FROM feedback");
	$stmt->execute();
...
.col-md-8 {
    width: 100%;
			...
			.bg-white label {
             ...
             <a href="pending_feedback.php" class="pending_list">Pending List</a>
              <a href="read_feedback.php" class="pending_list">Read List</a>
