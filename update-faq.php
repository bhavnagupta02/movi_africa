...
{ 
	...
	if(isset($_POST['faq_update'])){
        ...
        $faq_ans = $_POST['faq_ans'];
		   $stmt = $user_home->runQuery("UPDATE faq SET type=:type,faq_ques=:faq_ques,faq_ans=:faq_ans WHERE id=:id");
		...
		$stmts= $user_home->runQuery("SELECT * FROM faq where id=:id");
            ...
            <?php if(isset($msg)  && !empty($msg)  ){
              ...
              <form class="" method="post" enctype="multipart/form-data">
                <div class="col-md-8">
                    <div class="bg-white p20">
                        <div class="text list-features">
                            ...
                            <div class="form-group">
                                <label for="faq_ques">Question</label>
                                <input type="text" class="field-element" id="faq_ques" name="faq_ques" value="<?php echo $userRow['faq_ques']; ?>" placeholder="headline">
                            </div>
                            <div class="form-group">
                                <label for="faq_ans">Answer</label>
                                <textarea name="faq_ans" placeholder=""  rows="3" cols="80" class="field-element"><?php echo $userRow['faq_ans']; ?></textarea>
                            </div>
                    ...
                    <button id="faq_update" type="submit" class="button medium mat-blue-outline" name="faq_update" style="color:#4f9fcf;margin-bottom:20px;">update</button>
                </div>
                </div>
               </div>
            </form>
