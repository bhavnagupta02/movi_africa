...
$stmts= $user_home->runQuery("SELECT * FROM admin_manage WHERE id=7");
$stmts->execute();
$userRow=$stmts->fetch(PDO::FETCH_ASSOC);
   ...
   $id=7;
    ...
    if(isset($_POST['home_update'])){
       ...
       $stmt = $user_home->runQuery("UPDATE admin_manage SET type=:type,col1=:col1,col2=:col2,col3=:col3,col4=:col4,col5=:col5,col6=:col6,col7=:col7 WHERE id=:id");
        ...
        if($stmt->execute()){
        	$msg = 'Home page updated successfully';
        }
		else{
    ...
    height: 24px;left:0;
		...
		<div class="col-md-12">
            ...
            <?php if(isset($msg)  && !empty($msg)  ){
                echo $msg;
                echo '<script> setTimeout(function(){ window.location.href = "'.SITE_URL.'admin-home.php?id=7"; }, 2000);   </script>';
            } ?>           
                          ...
                          <br><br>
                            <div class="avatar-upload">
										<div class="avatar-edit">
											...
											<label for="imageUpload">Upload Logo Image</label> 
										</div>
								...
								<!--	 <label>Current Logo</label>-->
										<div class="avatar-preview">
										    ...
										    <img src="webimg/<?php echo $userRow['col1']; ?>" >
										</div>
                            ...
                            <div class="form-group">
						     ...
						     <div class="form-group">
                                ...
                                <input type="text" class="field-element" id="col4" name="col4" value="<?php echo $userRow['col4']; ?>" placeholder="">
                            </div>
                             
                              <div class="form-group">
                                <label for="about_me">Description</label>
                                <textarea name="col6" placeholder="Description"  rows="6" cols="80" class="field-element"><?php echo $userRow['col6']; ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="headline">Button</label>
                                <input type="text" class="field-element" id="col5" name="col5" value="<?php echo $userRow['col5']; ?>" placeholder="">
                            </div>
                            
                            <div class="form-group">
                                <label for="about_me">Service Text</label>
                                <textarea name="col7" placeholder="Service Text"  rows="6" cols="80" class="field-element"><?php echo $userRow['col7']; ?></textarea>
                            </div>
              ...
              <button id="home_update" type="submit" class="button medium mat-blue-outline" name="home_update" style="color:#4f9fcf;margin-bottom:20px;">update</button>
            </form>
        </div>   
