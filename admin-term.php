...
$stmts= $user_home->runQuery("SELECT * FROM admin_manage WHERE id=8");
      $stmts->execute();
    ...
    width: 100%;
		...
		<div class="col-md-6">
            ...
            <?php if(isset($msg)  && !empty($msg)  ){
                echo $msg;
                //echo '<script> setTimeout(function(){ window.location.href = "'.SITE_URL.'admin-term.php?id=8"; }, 2000);   </script>';
            } ?>           
